...
class _NewExpenseScreenState extends State<NewExpenseScreen> {
  ...
  Future<void> _loadFriends() async {
    ...
    try {
      ...
      // Initialize friends list with current user
  ...
  Future<void> _loadGroups() async {
    ...
    try {
      ...
      for (var doc in groupsSnapshot.docs) {
        ...
        if (data['memberDetails'] != null && data['memberDetails'] is List) {
                    ...
                    Expanded(
                      child: PageView(
                        ...
                        children: [
                          ...
                          ListView(
                            children: [
                              // List all friends including current user
                              ...friends.map((friend) {
                    ...
                    if (selectedFriends.length >
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            // Get selected friends including the current user
                            List<Map<String, dynamic>> selectedFriendDetails =
                                [];

                            // Add all selected friends
                            selectedFriendDetails.addAll(
                              friends.where(
                                (friend) =>
                            ...
                            // Navigate to expense split screen with selected friends
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder:
